...
class OnionCodecsSpec extends AnyFunSuite {
  ...
  test("encode/decode variable-length (tlv) final per-hop payload") {
    val testCases = Map(
      ...
      TlvStream[OnionTlv](AmountToForward(561 msat), OutgoingCltv(CltvExpiry(42)), NextPointTweak(PrivateKey(hex"eec7245d6b7d2ccb30380bfbe2a3648cd7a942653f5aa340edcea1f283686619"))) -> hex"31 02020231 04012a ff000555555555555520eec7245d6b7d2ccb30380bfbe2a3648cd7a942653f5aa340edcea1f283686619"
    )
