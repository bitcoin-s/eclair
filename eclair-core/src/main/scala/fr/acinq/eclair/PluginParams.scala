...
import fr.acinq.eclair.transactions.IncomingTlc
...
trait CustomCommitmentsPlugin extends PluginParams {
   ...
   */
  def getIncomingHtlcs: Seq[IncomingUpdateAddMessage]
   ...
   * returned by this method.
   */
  def getHtlcsRelayedOut(htlcsIn: Seq[IncomingUpdateAddMessage]): Map[Origin, Set[(ByteVector32, Long)]]
}